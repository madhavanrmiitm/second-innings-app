...
class LocalGroupsView extends StatelessWidget {
  ...
  final List<Map<String, String>> localGroups = const [
    {'name': 'Senior Walkers Club', 'description': 'Meet every morning for a walk in the park.'},
    {'name': 'Book Readers Society', 'description': 'Discuss books and enjoy literary events.'},
    {'name': 'Gardening Enthusiasts', 'description': 'Share tips and grow plants together.'},
    {'name': 'Crafting Circle', 'description': 'Work on various crafts and share your creations.'},
