...
from app.payloads import TokenRequest, ReviewCaregiver, ResolveTicket
...
async def review_caregiver(request: Request, caregiverId: int, validated_data: ReviewCaregiver):
...
async def resolve_ticket(request: Request, ticketId: int, validated_data: ResolveTicket):
