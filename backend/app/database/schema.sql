...
-- Open ticket with assignment
INSERT INTO tickets (user_id, assigned_to, subject, description, status) VALUES
(8, 11, 'Profile not updating', 'Changes to profile are not being saved', 'open'),
(7, 12, 'Notification issues', 'Not receiving any notifications', 'open');
